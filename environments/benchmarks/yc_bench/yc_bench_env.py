    ...
    async def setup(self):
        ...
        try:
            result = subprocess.run(
                ["yc-bench", "--help"], capture_output=True, text=True, encoding="utf-8", errors="replace", timeout=10
            )
    ...
    async def rollout_and_score_eval(self, eval_item: Dict[str, Any]) -> Dict:
        ...
        try:
            ...
            init_result = subprocess.run(
                init_cmd, capture_output=True, text=True, encoding="utf-8", errors="replace", timeout=30,
            )
