...
async def qr_login(
    ...
    *,
    ...
    async with aiohttp.ClientSession(trust_env=True, connector=_make_ssl_connector(), timeout=aiohttp.ClientTimeout(total=30)) as session:
        try:
...
class WeixinAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        self._poll_session = aiohttp.ClientSession(trust_env=True, connector=_make_ssl_connector(), timeout=aiohttp.ClientTimeout(total=30))
        self._send_session = aiohttp.ClientSession(trust_env=True, connector=_make_ssl_connector(), timeout=aiohttp.ClientTimeout(total=30))
